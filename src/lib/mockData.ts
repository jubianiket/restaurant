...
export const mockMenuItems: MenuItem[] = [
  { id: '1', name: 'Margherita Pizza', description: 'Classic cheese and tomato.', price: 299, category: 'Pizza', portion: '12 inch', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'pizza margherita', userId: DEMO_USER_ID },
  { id: '2', name: 'Pepperoni Pizza', description: 'Spicy pepperoni & cheese.', price: 349, category: 'Pizza', portion: '12 inch', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'pizza pepperoni', userId: DEMO_USER_ID },
  { id: '3', name: 'Caesar Salad', description: 'Crisp romaine, croutons, Parmesan.', price: 220, category: 'Salads', portion: 'Full', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'caesar salad', userId: DEMO_USER_ID },
  { id: '4', name: 'Spaghetti Carbonara', description: 'Creamy egg sauce, pancetta.', price: 380, category: 'Pasta', portion: 'Full', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'spaghetti carbonara', userId: DEMO_USER_ID },
  ...
  { id: '6', name: 'Coca-Cola', description: 'Classic soft drink.', price: 60, category: 'Drinks', portion: '300ml', imageUrl: 'https://placehold.co/300x300.png', dataAiHint: 'coca cola', userId: DEMO_USER_ID },
  ...
  { id: '8', name: 'Alfredo Pasta', description: 'Fettuccine in a creamy parmesan sauce.', price: 360, category: 'Pasta', portion: 'Full', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'alfredo pasta', userId: DEMO_USER_ID },
  { id: '9', name: 'Paneer Tikka', description: 'Tandoori spiced paneer skewers.', price: 250, category: 'Starters', portion: '8 pieces', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'paneer tikka', userId: OTHER_USER_ID },
  { id: '10', name: 'Chicken Wings', description: 'Spicy buffalo wings with dip.', price: 320, category: 'Starters', portion: '6 pieces', imageUrl: 'https://placehold.co/600x400.png', dataAiHint: 'chicken wings', userId: OTHER_USER_ID },
];
